                        ...
                        <div class="d-sm-flex justify-content-between">
                            <div data-aos="zoom-in-up">
                                <div class="banner-title">
                                    <h3 class="font-weight-medium">Selamat datang di EXPO
        ...
        <div class="container">
            <div class="row mb-5 pb-5">
                <div class="col" data-aos="fade-up" data-aos-offset="-500">
                    <h3 class="font-weight-medium text-dark mt-5 mt-lg-0">Daftar Hadir EXPO</h3>
                    <h5 class="text-dark mb-5">Silahkan mengisi daftar hadir expo</h5>
                    <p class="mb-4">
                        <font color="green"><?php echo $this->session->flashdata('pesan_tamu'); ?></font>
                    </p>
                    <?php echo form_open('Expo/expo_proses', ''); ?>
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <?php echo form_error('sekolah', '<div class="text-danger"><small>', '</small></div>'); ?>
                            </div>
                        </div>
                        <div class="col-sm-12">
        ...
        <div class="container">
            <div class="row  mt-md-0 mt-lg-4">
                <div class="col-sm-6 text-white" data-aos="fade-up">
                    <p class="font-weight-bold mb-3">Daftar Expo</p>
                    <h3 class="font-weight-medium">Daftar hadir expo hari ini</h3>
                            ...
                            foreach ($tamu as $datatamu) { ?>
                                <li>
                                    <div class="testimonial-item">
                                        ...
                                        <p class="testimonial-destination"><?php echo $datatamu->sekolah; ?></p>
