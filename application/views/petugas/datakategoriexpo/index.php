...
<div class="main-content">
        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">Data Kategori Expo</h4>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?= base_url('petugas/'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active">Data Kategori Expo</li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="modal" id="modal-kategori" tabindex="-1">
                ...
                <div class="modal-body">
                    <form id="form-kategori">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="id_kategori_expo" name="id_kategori_expo">
