<footer class="footer">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <?php echo date("Y"); ?> © ITS PKU Muhammadiyah Surakarta.
            </div>
            <div class="col-sm-6">
                <div class="text-sm-right d-none d-sm-block">
                    Crafted with <i class="mdi mdi-heart text-danger"></i> by Team IT ITS PKU Muhammadiyah Surakarta
                </div>
            </div>
        </div>
    </div>
...
<!-- apexcharts -->
<script src="<?= base_url('assets_petugas/'); ?>libs/apexcharts/apexcharts.min.js"></script>

<script src="<?= base_url('assets_petugas/'); ?>libs/jquery-knob/jquery.knob.min.js"></script>

<!-- Jq vector map -->
<script src="<?= base_url('assets_petugas/'); ?>libs/jqvmap/jquery.vmap.min.js"></script>
<script src="<?= base_url('assets_petugas/'); ?>libs/jqvmap/maps/jquery.vmap.usa.js"></script>

<script src="<?= base_url('assets_petugas/'); ?>js/pages/dashboard.init.js"></script>
